...
import {setMember} from '../../actions/user'
    ...
    return (
      <div className='ui container'>
          ...
          <div className='ui' style={{padding: '30px 10px'}}>
            <div id='membership-info-body' style={{minHeight: '200px'}}>
              {(membershipInfo.email) ? (<div>
                ...
                <br />
                Trạng thái: <span
                style={{color: 'red'}}>{membershipInfo.state === 'pending' ? 'Đang xử lý' : membershipInfo.state}</span>
                <br />
                <br />
                {(userInfo.info) ? (<div>
                ...
                <div>
                  Mọi thông tin chi tiết xin vui lòng liên hệ qua số điện thoại <strong style={{color: 'red'}}>098 499
                  5157</strong>
                </div>
              </div>) : ('')}
            </div>
                ...
                <div className='ui list'>
                  ...
                  <div className='item'>
                    ...
                    <div className='content'>
                      ...
                      <span style={{marginLeft: '20px'}}>1 tháng: <span
                        style={{color: 'red'}}>{fn.numberWithCommas(price.one)} đ </span></span><br />
                      <span style={{marginLeft: '20px'}}>3 tháng: <span
                        style={{color: 'red'}}>{fn.numberWithCommas(price.three)} đ</span></span><br />
                      <span style={{marginLeft: '20px'}}>6 tháng: <span
                        style={{color: 'red'}}>{fn.numberWithCommas(price.six)} đ</span></span><br />
                      <span style={{marginLeft: '20px'}}>1 năm: <span
                        style={{color: 'red'}}>{fn.numberWithCommas(price.twelve)} đ</span></span><br />
                    </div>
                  </div>
                </div>
        ...
        <div className='ui large second coupled modal'>
          ...
          <div className='ui'>
            <h3 style={{textAlign: 'center'}}>Bạn đang đăng ký gói <span id='month'
                                                                         style={{color: 'red'}}>{(mData.membership.month === 12) ? ('1 năm') : (mData.membership.month + ' tháng')}</span>,
              hay chọn hình thức thanh toán phía dưới</h3>
          </div>
          ...
          <div className='ui stackable grid'>
            <div className='eight wide column'>
              <div className='ui bottom attached tab segment noBor active' data-tab='first'>
                ...
                <h3>Điện thoại liên hệ: <span style={{color: 'red'}}>0975 622 789</span> - <span style={{color: 'red'}}>0949 958 898</span>
                </h3>
              </div>
                          ...
                          onClick={() => {
                            ...
                            if (checkPhoneNumber(phone)) {
                              ...
                              axios.post(
                                ...
                                that.context.store.dispatch(setMember(res.data))
